...
export const projects: Project[] = [
  ...
  },
  {
    ...
    detail: {
      ...
      slides: [
        {
          label: "Homepage oranje",
          gradient: "from-primary/60 via-[#8E5CE0]/50 to-secondary/50",
          src: "/mockup/zd-orange-mockup-mobile-with-hand-and-desktop.webp",
          alt: "De Ziggo Dome homepage op desktop en op een telefoon in de hand, op een oranje achtergrond",
        },
        {
          label: "Homepage donker",
          gradient: "from-primary-800 via-primary/40 to-secondary/40",
          src: "/mockup/zd-dark-mockup-mobile-with-hand-and-desktop.webp",
          alt: "De Ziggo Dome homepage op desktop en op een telefoon in de hand, op een donkere achtergrond",
        },
        {
          label: "Agenda oranje",
          gradient: "from-[#8E5CE0]/50 via-primary-700/40 to-primary/60",
          src: "/mockup/ziggodome-orange-itereren-agenda-3screens.webp",
          alt: "Drie schermen die de agendapagina tonen van wireframe tot definitief ontwerp, op een oranje achtergrond",
        },
        {
          label: "Agenda donker",
          gradient: "from-primary/50 via-[#8E5CE0]/40 to-secondary/50",
          src: "/mockup/ziggodome-dark-itereren-agenda-3screens.webp",
          alt: "Drie schermen die de agendapagina tonen van wireframe tot definitief ontwerp, op een donkere achtergrond",
        },
      ],
    },
  },
